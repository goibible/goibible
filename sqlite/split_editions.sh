...
SRC="${1:-/home/albert/projects/bible/GOI_bible.sqlite3}"
OUT_DIR="${2:-/home/albert/projects/bible/sqlite/editions}"
mkdir -p "$OUT_DIR"
...
INSERT INTO book_names SELECT * FROM src.book_names WHERE edition_id = '$ed';
